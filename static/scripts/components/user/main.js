...
class User extends React.Component{
    ...
    changeOpacity(srcollY){
       if (this.refs.header) this.refs.header.addOpacity(parseFloat(window.pageYOffset/srcollY));
    }
    ...
    render() {
        ...
        <div>
            <Header
                ...
                title={ !InfoData ? UserInfo ? UserInfo.name:"" : InfoData.data.name }
                titleHidden="true"
                RightBtn="设置"
                        ...
                        ?
                            <div ref="body" className="userBody">
                                <div className="userTop">
                                    <img ref="userAvator" className="userAvator" src="static/images/beaut.jpg" />
                                    <div className="user">
                                        <div className="userData">
                                            <div className="userState">
                                                <img src={InfoData?"http://www.ih5.cn"+InfoData.data.picture:UserInfo.avatar} />
                                                <div className="State">
                                            ...
                                            <div className="userPoint">
                                                <h4>{UserInfo.point}<img src="../../../static/images/GoldCoin.png" /></h4>
                                            </div>
                                            <div className="clearfix"></div>
                                        </div>
                                    </div>
                                ...
                                <ul className="navList">
                                    ...
                                    <li>
                                        <div className="PointOperation">
                                            <div className="floatLeft"><img src="../../../static/images/file.png" /><span>上传附件简历</span></div>
                                            <div className="floatRight"><span>送20积分</span><img src="../../../static/images/right.png" /></div>
                                            <div className="clearfix"></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="Operation">
                                            <div className="floatLeft">
                                                <img src="../../../static/images/task.png" /><span>积分任务</span>
                                            </div>
                                        ...
                                        <div className="Operation">
                                            <div className="floatLeft">
                                                <img src="../../../static/images/trophy.png" /><span>成就</span>
                                            </div>
                                            <div className="floatRight">
                                                <span></span>
                                                <img src="../../../static/images/right.png" />
                                        ...
                                        <div className="Operation">
                                            <div className="floatLeft">
                                                <img src="../../../static/images/bean.png" /><span>真豆</span>
                                            </div>
                                            <div className="floatRight">
                                                <span>0</span>
                                                <img src="../../../static/images/right.png" />
                                        ...
                                        <div className="Operation">
                                            <div className="floatLeft">
                                                <img src="../../../static/images/money.png" /><span>零钱</span>
                                            </div>
                                            <div className="floatRight">
                                                <span>0元</span>
                                                <img src="../../../static/images/right.png" />
                                    ...
                                    <li>
                                        <div className="Operation">
                                            <div className="floatLeft">
                                                <img src="../../../static/images/case.png" /><span>我的道具</span>
                                            </div>
                                            <div className="floatRight">
                                                <span>拥有：<b>0</b></span><span>使用中:<b>0</b></span>
                                                <img src="../../../static/images/right.png" />
                                            </div>
                                            <div className="clearfix"></div>
                                        </div>
