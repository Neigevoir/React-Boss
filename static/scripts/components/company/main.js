    ...
    CorperationaddEvent(){
        ...
        this.refs.companyList.addEventListener('touchmove',(e)=>{
            ...
            if (moveY>0&&this.ScrollTop==0) {
                e.preventDefault();
                this.refs.companyList.style.webkitTransform = 'translateY('+moveY+ 'px)';
            }
        })
        ...
        return (
            <div>
        		...
        		<ul ref="companyList" className="companyList">
                {
                    ...
                    return<li key={k} onClick={this.showCompanyDetail.bind(null,v)}>
                            <div className="companys">
                                <img className="companyPic" src={v.image} />
                                <div className="companyPro">
                                    <img className="companyLogo" src={v.image?v.image:"../../../static/images/logo.jpg"} />
                                    <div className="companyContent">
                                        <span className="companyText">{v.user.nick_name?v.user.nick_name:""}</span>
