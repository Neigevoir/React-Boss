...
class PositionList extends React.Component{
    ...
    addScroll(e){
        let startX,moveX,endX,startY,moveY,endY,Type,Num=0;
        ...
        this.refs.position.addEventListener('webkitTransitionEnd',(e)=>{
            ...
            if (Type=='x') {
                ...
                if (Math.abs(moveY)>parseInt((window.screen.availHeight-135))*0.25) {
            ...
            <div ref="body" className="positionListBody">
                <div ref="position" className="positionList">
                    <ul className="positionUl">
                    {
                        ...
                        return  <li key={k} onClick={this.positionDetail.bind(null,v)}>
                                    <div className="position_content">
                                        ...
                                        <div className="positionCompany">
                                            <div>
                                                <img className="avator" src={v.image?v.image:"../../../static/images/logo.jpg"} />
                                                <div className="company_pro clearfix">
                                                    <span className="company_text">
                                                        {Array.from(v.user.name).length>5?v.user.name.substring(0,5):v.name} |
                                                        {Array.from(v.title).length>5?v.title.substring(0,5):v.title } |
                                                        CEO
                                                    </span>
                                                    <span className="company_text">{v.play_count}人以上</span>
                                                </div>
                                            </div>
                                        </div>
