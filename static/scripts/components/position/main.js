...
class Position extends React.Component{
    ...
    componentDidMount(){
        ...
        this.refs.navRightSlide.style.webkitTransform = 'translateX('+ window.screen.availWidth + 'px)';
    }
    ...
    render() {
        let { PositionData,PositionType } = this.props;
        if (PositionData){
            // console.log(PositionData)
        }
        let position = 'recommend';
        return (
            <div className="positionBody">
                ...
                <section className="navSlideBody">
                    <nav className="navSlide">
                        <span
                            className={position=='recommend'?"slideRemon select":"slideRemon"}
                        ...
                        >最热</span>
                        <span className="slideSelect" onClick={this.TitleChange.bind(null,"show")}>
                            <img className="Select" src="../../static/images/Speaker.png" />
                        </span>
                    </nav>
                    <nav ref="navRightSlide" className="navRightSlide transition">
                        <span onClick={this.showSelectModal} className="slideRemon" >薪水</span>
                        <span onClick={this.showSelectModal} className="slideNew" >经验</span>
                        <span onClick={this.showSelectModal} className="slideHot" >公司规模</span>
                        <span className="slideSelect" onClick={this.TitleChange.bind(null,"hidden")}>
                            <img className="arrow" src="../../static/images/arrow_right.png" />
                        </span>
                    </nav>
                </section>
                <PositionList
